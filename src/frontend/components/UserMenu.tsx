  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="flex w-full cursor-pointer items-center gap-2 rounded-md px-4 py-1.5 text-sm transition-colors whitespace-nowrap overflow-hidden hover:bg-muted/50"
