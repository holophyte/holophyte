 ...
 * may be in different personal orgs. Gated by ALLOW_ANONYMOUS_AUTH env var
 * so it is inert on production deployments. Only exposes heartbeat metadata
 * (lastSeen, sessionCount, machineId, url).
 */
